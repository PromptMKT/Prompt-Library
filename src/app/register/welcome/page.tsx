  ...
  return (
    <main className="min-h-dvh bg-[#080b17] text-white flex items-center justify-center px-6 py-12">
      ...
      <section className="relative w-full max-w-xl rounded-3xl border border-white/10 bg-[#0d1325]/95 p-7 sm:p-10 text-center space-y-6 shadow-[0_30px_90px_rgba(0,0,0,0.55)]">
        <div className="mx-auto w-28 h-28 rounded-full bg-linear-to-b from-primary/30 to-primary border border-primary/40 shadow-[0_0_60px_hsl(var(--primary)/0.35)] flex items-center justify-center">
        ...
        <div className="space-y-3 pt-2">
          <Link
            href="/explore"
            className="h-12 rounded-2xl bg-primary text-primary-foreground text-sm font-black uppercase tracking-[0.16em] inline-flex items-center justify-center w-full hover:bg-primary/90 transition-colors"
          >
            Explore Prompts
          </Link>
          <Link
