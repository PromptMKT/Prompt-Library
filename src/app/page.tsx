  ...
  >
    ...
    {author && (
      ...
      <div className="w-6 h-6 rounded-full overflow-hidden shrink-0">
        <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${author}`} className="w-full h-full object-cover" alt="" />
      </div>
    ...
    <div className="p-4 space-y-3">
      ...
      <div className="flex items-center justify-between pt-2 border-t border-border/50">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-full overflow-hidden shrink-0">
            <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${p.author}`} className="w-full h-full object-cover" alt="" />
          </div>
  ...
  >
    ...
    <div className="px-5 pb-5 relative">
      <div className="absolute -top-7 left-5 w-14 h-14 rounded-full border-4 border-card bg-card overflow-hidden shadow-lg z-10">
        <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${c.seed}`} className="w-full h-full object-cover relative z-10" alt="" />
      </div>
  ...
  >
    ...
    <div className="p-3 flex flex-col h-full bg-white relative">
      ...
      <div className="flex items-center gap-1.5 pt-2 border-t border-slate-100 mt-auto">
        <div className="w-4 h-4 rounded-full overflow-hidden flex items-center justify-center shadow-sm shrink-0">
          <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${p.author}`} className="w-full h-full object-cover" alt="" />
        </div>
