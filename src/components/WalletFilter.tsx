...
export const WalletFilter = () => {
  ...
  return (
    <div className="flex items-center gap-2 group">
      ...
      <Link href="/coins" className="h-9 w-9 rounded-xl bg-primary flex items-center justify-center text-white hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95 hidden lg:flex">
